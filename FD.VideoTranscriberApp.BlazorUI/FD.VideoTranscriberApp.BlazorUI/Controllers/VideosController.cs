...
namespace FD.VideoTranscriberApp.BlazorUI.Controllers
{
    ...
    public class VideosController : ControllerBase
    {
        ...
        public async Task<IActionResult> UploadAsync(VideoUploadRequest request, CancellationToken cancellationToken)
        {
            try
            {
                ...
                var transcriptions =
                    await TranslateTranscriptionsAsync(transcriptionResponse, request.Languages, cancellationToken);
        ...
        private async Task<List<TranscriptionModel>> TranslateTranscriptionsAsync(TranscribeAudioResponse transcription, string[] languages, CancellationToken cancellationToken)
        {
            ...
            var results = await Task.WhenAll(tasks); //WhenAll : tüm islemler ayni anda baslar ve en son bitirenin süresince toplam islemi bitirir. Ayri ayri await yapsaydik, herbirinin bitirme süresini üzerine ekler.
            ...
            var completionResult = await _openAiService.ChatCompletion.CreateCompletion(new ChatCompletionCreateRequest
            {
                Messages = new List<ChatMessage>
                {
                    ChatMessage.FromSystem(
                        $"You are a helpful translator from English to {transcription.Language}. You've worked as a translator your whole life and are very good at it. Don't include any extra explanations in your responses!"),
        ...
        private async Task<string> ExtractAudioFromVideoAsync(string videoFilePath, CancellationToken cancellationToken)
        {
            ...
            FFmpeg.SetExecutablesPath("C:\\Videos\\ffmpeg");
